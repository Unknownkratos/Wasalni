  ...
  namespace svelteHTML {
    ...
    interface IonInput {
      ...
      */
      ...
      /**
      * (event : InputInputEventDetail) => void :  The `ionInput` event fires when the `value` of an `<ion-input>` element has been changed.  For elements that accept text input (`type=text`, `type=tel`, etc.), the interface is [`InputEvent`](https://developer.mozilla.org/en-US/docs/Web/API/InputEvent); for others, the interface is [`Event`](https://developer.mozilla.org/en-US/docs/Web/API/Event). If the input is cleared on edit, the type is `null`.
      */
    ...
    interface IonPicker {
      ...
      */
      "on:didDismiss"?: (event: CustomEvent<OverlayEventDetail<any>> & { target: HTMLIonPickerElement }) => void;
      ...
      */
      "on:willDismiss"?: (event: CustomEvent<OverlayEventDetail<any>> & { target: HTMLIonPickerElement }) => void;
    ...
    interface IonTextarea {
      ...
      */
      ...
      /**
      * (event : TextareaInputEventDetail) => void :  The `ionInput` event fires when the `value` of an `<ion-textarea>` element has been changed.  When `clearOnEdit` is enabled, the `ionInput` event will be fired when the user clears the textarea by performing a keydown event.
      */
